-- Session 00012: Teams-First EDL MVP Database Schema (FIXED)
-- Created: 2025-08-16
...
-- FIX: Removed test user inserts (auth.users must be created through Supabase Auth)
...
-- Success message
SELECT '✅ Teams-first schema created successfully!' as status,
       'Next: Create users through Supabase Auth, then profiles' as next_step;