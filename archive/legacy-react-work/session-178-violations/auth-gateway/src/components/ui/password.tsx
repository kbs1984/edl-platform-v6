...
export const PasswordInput = (props: InputProps) => {
  ...
  return (
    <div className="relative">
      ...
      <div className={`absolute top-full w-full z-50 rounded bg-popover border border-popover-foreground/90 shadow-lg px-4 py-3 flex flex-col gap-2 text-sm translate-y-3 
        ${(!focused || (isLongEnough && hasDigit && hasSpecialCharacter && hasLetter)) && "hidden"}`}
      >
