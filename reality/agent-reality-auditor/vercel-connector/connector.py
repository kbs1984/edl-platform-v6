...
class VercelRealityAgent:
    ...
    def __init__(self):
        ...
        # Vercel API configuration with v6 project defaults
        self.token = os.environ.get('VERCEL_TOKEN', 'vSwBtmN7Em4UyvUYIfKpie7h')
        self.project_id = os.environ.get('VERCEL_PROJECT_ID', 'prj_ssLAwCWAujrODuMzgoAgwtb3MPxq')
